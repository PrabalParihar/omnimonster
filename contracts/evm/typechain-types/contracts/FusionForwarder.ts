...
export interface FusionForwarderInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "eip712Domain"
      | "execute"
...
export interface FusionForwarder extends BaseContract {
  connect(runner?: ContractRunner | null): FusionForwarder;
  waitForDeployment(): Promise<this>;

  interface: FusionForwarderInterface;
